...
def _render_sidebar():
    with st.sidebar:
        ...
        st.markdown('<hr><div style="font-size:11px;opacity:0.4;text-align:center;line-height:1.9">Python · Streamlit · OpenCV<br>智谱AI GLM-4 · Streamlit Community Cloud<br>© 2025 SZTU PhysLab · v5.0</div>', unsafe_allow_html=True)
    return page
